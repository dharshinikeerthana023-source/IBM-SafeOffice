/**
 * SAFE OFFICE — Smart Employee Activity Monitoring System
...
function generatePDF() {
  // Gather options
  const title    = document.getElementById('pdfTitle').value || 'SAFE OFFICE Security Report';
  ...
  html += `
    <div class="pdf-footer">
      <div class="pdf-footer-left">
        SAFE OFFICE v4.2.1 &nbsp;|&nbsp; ${classif} &nbsp;|&nbsp; Do not distribute without authorization
      </div>
      <div class="pdf-footer-right">
        Generated: ${dateStr} ${timeStr}<br/>
        © 2026 SAFE OFFICE Corp. All rights reserved.
      </div>
    </div>
    </div>
  `;
